 ...
 *
 */
public class PagingBeanComment {
	/**
	 * 총 데이터(항목)의 개수
	 */
	 ...
	 */
	private int housePerPage = ConstantsComment.ITEMS_PER_PAGE;
	/**
	 * Page Group 내 Page 수.  페이지 그룹에 들어갈 페이지 개수
	 */
	private int pagesPerPagegroup = ConstantsComment.PAGES_PER_PAGEGROUP;
	 ...
	 * @param page 보려는 페이지.
	 */
	public PagingBeanComment(int totalHouse, int page) {
