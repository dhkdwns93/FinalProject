...
public class PagingBeanReview {
	 ...
	 */
	private int itemsPerPage = ConstantsReview.ITEMS_PER_PAGE;
	/**
	 * Page Group 내 Page 수.  페이지 그룹에 들어갈 페이지 개수
	 */
	private int pagesPerPagegroup = ConstantsReview.PAGES_PER_PAGEGROUP;
	 ...
	 * @param page 보려는 페이지.
	 */
	public PagingBeanReview(int totalItems, int page) {
