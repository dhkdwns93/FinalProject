...
<body>
<form action="${initParam.rootPath}/common/shop/addShop.do" method="post" enctype="multipart/form-data">
<table border="1" style="border-collapse:collapse; text-align:center;" align="center">
	<tr>
		...
		<td colspan="2"><input type="file" id="shopImg" name="shopImg" class="hide"></td>
	</tr>
	<tr>
		<td>이름</td>
		<td><input type="text" name="shopName"  class="hide">
			<span class="error"><form:errors path="shop.shopName" delimiter="&nbsp;"/>
	...
	<tr>
		<td>url</td>
		<td><input type="text" name="shopAddress"  class="hide">
			<span class="error"><form:errors path="shop.shopAddress" delimiter="&nbsp;"/>
				<c:if test="${requestScope.error != null }">${requestScope.error }</c:if>
			</span>
		</td>
	</tr>
