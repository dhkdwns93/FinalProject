...
<div id="pattern" class="pattern">
	...
	<div class="form-inline form-group" >
		<div class="part">
	<!-- select 검색기능 -->
	<form class="form-inline" method="post" action="${initParam.rootPath }/boardRecipe/selectSearch.do">
		<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }">
...
<p>	
	<%-- ######################################################
			...
			###################################################### --%>
	<!-- 첫페이지로 이동 -->
	<a href="${initParam.rootPath }/boardRecipe/boardSearchByMemberId.do?page=1&memberId=${requestScope.memberId}">첫페이지</a>
	...
	<c:choose>
		<c:when test="${requestScope.pageBean.previousPageGroup }" >
			...
			<a href="${initParam.rootPath }/boardRecipe/boardSearchByMemberId.do?page=${requestScope.pageBean.beginPage - 1}&memberId=${requestScope.memberId}">◀</a>
		</c:when>
		<c:otherwise>
			◀	
		</c:otherwise>
	...
	<c:forEach begin="${requestScope.pageBean.beginPage }" end="${requestScope.pageBean.endPage }" var="page">
			   <c:choose>
			   	...
			   	<!-- 현재페이지가 아니라면 -->
					<a href="${initParam.rootPath }/boardRecipe/boardSearchByMemberId.do?page=${page}&memberId=${requestScope.memberId}">&nbsp;${page}&nbsp;</a>
	...
	<c:choose>
		<c:when test="${requestScope.pageBean.nextPageGroup}">
			<a href="${initParam.rootPath }/boardRecipe/boardSearchByMemberId.do?page=${requestScope.pageBean.endPage + 1}&memberId=${requestScope.memberId}">▶</a>
		</c:when>
		<c:otherwise>
		▶
		</c:otherwise>
	...
	<a href="${initParam.rootPath }/boardRecipe/boardSearchByMemberId.do?page=${requestScope.pageBean.totalPage}&memberId=${requestScope.memberId}">마지막 페이지</a>
