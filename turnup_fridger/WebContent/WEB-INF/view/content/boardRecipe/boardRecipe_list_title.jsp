...
<p>	
	<%-- ######################################################
			...
			###################################################### --%>
	<!-- 첫페이지로 이동 -->
	<a href="${initParam.rootPath }/boardRecipe/boardRecipe_list_title.do?page=1&title=${requestScope.title}">첫페이지</a>
	...
	<c:choose>
		<c:when test="${requestScope.pageBean.previousPageGroup }" >
			...
			<a href="${initParam.rootPath }/boardRecipe/boardRecipe_list_title.do?page=${requestScope.pageBean.beginPage - 1}&title=${requestScope.title}">◀</a>
		</c:when>
		<c:otherwise>
			◀	
		</c:otherwise>
	...
	<c:forEach begin="${requestScope.pageBean.beginPage }" 
			   ...
			   <c:choose>
			   	...
			   	<!-- 현재페이지가 아니라면 -->
					<a href="${initParam.rootPath }/boardRecipe/boardRecipe_list_title.do?page=${page}&title=${requestScope.title }">&nbsp;${page}&nbsp;</a>
	...
	<c:choose>
		<c:when test="${requestScope.pageBean.nextPageGroup}">
			<a href="${initParam.rootPath }/boardRecipe/boardRecipe_list_title.do?page=${requestScope.pageBean.endPage + 1}&title=${requestScope.memberId}">▶</a>
		</c:when>
		<c:otherwise>
		▶
		</c:otherwise>
	...
	<a href="${initParam.rootPath }/boardRecipe/boardRecipe_list_title.do?page=${requestScope.pageBean.totalPage}&title=${requestScope.title}">마지막 페이지</a>
