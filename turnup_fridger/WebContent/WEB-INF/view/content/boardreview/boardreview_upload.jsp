...
.boardReviewStar>.input>input:checked+label{
...
.boardReviewStar>.input>input{
    position: absolute;
    width: 1px;
    height: 1px;
    opacity: 0;
}
.boardReviewStar>.input.focus{
    outline: 1px dotted #ddd;
}
.boardReviewStar>.input>label{
    width: 10px;
    height: 0;
    padding: 19px 0 0 0;
    overflow: hidden;
...
.boardReviewStar>.input>label:hover~label{
    background-image: none;
}
.boardReviewStar>.input>label[for="p1"]{ 
    width: 10px;
    z-index: 10;
}
.boardReviewStar>.input>label[for="p2"]{ 
    width: 20px;
    z-index: 9;
}
.boardReviewStar>.input>label[for="p3"]{ 
    width: 30px;
    z-index: 8;
}
.boardReviewStar>.input>label[for="p4"]{ 
    width: 40px;
    z-index: 7;
}
.boardReviewStar>.input>label[for="p5"]{ 
    width: 50px;
    z-index: 6;
}
.boardReviewStar>.input>label[for="p6"]{ 
    width: 60px;
    z-index: 5;
}
.boardReviewStar>.input>label[for="p7"]{ 
    width: 70px;
    z-index: 4;
}
.boardReviewStar>.input>label[for="p8"]{ 
    width: 80px;
    z-index: 3;
}
.boardReviewStar>.input>label[for="p9"]{ 
    width: 90px;
    z-index: 2;
}
.boardReviewStar>.input>label[for="p10"]{ 
    width: 100px;
    z-index: 1;
}
.boardReviewStar>output{
    display: inline-block;
    width: 36px;
    text-align: right;
}
.boardReviewStar>output>b{
    	...
    	<td>			
				<span class="boardReviewStar">
				  <span class="input">
				    ...
				    <input type="radio" name="boardReviewStar" id="p5" value="5"><label for="p5">5</label>
