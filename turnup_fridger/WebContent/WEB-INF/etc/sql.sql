...
DELETE FROM MEMBER;
CREATE TABLE MEMBER (
   LOGIN_ID VARCHAR2(20) PRIMARY KEY, /* 회원ID */
   LOGIN_PW VARCHAR2(20) NOT NULL, /* 패스워드 */
   ...
   CONSTRAINT MEMBER_LOGIN_ID_FK FOREIGN KEY(LOGIN_ID) REFERENCES AUTHORITY
);
select * from member;
...
DELETE FROM ADMIN;
CREATE TABLE ADMIN (
   LOGIN_ID VARCHAR2(20) PRIMARY KEY, /* 관리자 ID */
   LOGIN_PW VARCHAR2(20) NOT NULL, /* 비밀번호 */
   ...
   CONSTRAINT ADMIN_LOGIN_ID_FK FOREIGN KEY(LOGIN_ID) REFERENCES AUTHORITY
);
...
CREATE TABLE COMMENT_QNA (
   ...
   CONSTRAINT COMMENT_QNA_MEMBER_ID_FK FOREIGN KEY(MEMBER_ID) REFERENCES MEMBER,
